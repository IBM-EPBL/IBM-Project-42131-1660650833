...
import ibm_db
conn = ibm_db.connect("DATABASE=db;HOSTNAME=662264db-5624-4b7c-82df-40d1699856897c2.cs2io90l0823b1od8lcg.databases.appdomain.cloud;PORT=32536;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=ydk44341;PWD=eENReIXIS7xOOBBa",'','')

app = Flask(__name__)
app.secret_key = b'_7#yds2L"F9Q3z\n\xec]/'
